...
class upload {
    ...
    function upload($file, $lang = 'en_GB') {
		...
		$this->translation['image_too_wide']              = 'Resim izin verilenden çok geniş.';
		$this->translation['image_too_narrow']            = 'Resim izin verilenden çok dar.';
		$this->translation['image_too_high']              = 'Resim izin verilenden çok uzun.';
		$this->translation['image_too_short']             = 'Resim izin verilenden çok kısa.';
		$this->translation['ratio_too_high']              = 'Resim oranı çok yüksek (resim çok geniş).';
		$this->translation['ratio_too_low']               = 'Resim oranı çok düşük (resim çok uzun).';
		$this->translation['too_many_pixels']             = 'Resim izin verilenden büyük.';
		$this->translation['not_enough_pixels']           = 'Resim izin verilenden küçük.';
		...
		$this->translation['create_error']                = 'Kaynaktan %s resmi oluşturulurken hata oluştu.';
		$this->translation['source_invalid']              = 'Resim dosyası okunamadı. Dosyanın bir resim olduğundan emin misiniz?';
		$this->translation['gd_missing']                  = 'Sunucuda GD kütüphanesi olmadığı için işleme devam edemiyorsunuz.';
		$this->translation['watermark_no_create_support'] = '%s resmi oluşturulamadığı için filigran oluşturulamadı.';
		$this->translation['watermark_create_error']      = '%s resmi okunamadığı için filigran oluşturulamadı.';
